  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover truth with Newssearch app - your trusted source for fact-checked news. Explore, filter, and learn with our user-friendly features, ensuring accuracy at your fingertips."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1495020689067-958852a7765e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxuZXdzfGVufDB8fHx8MTY5NDAxNDU1OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover truth with Newssearch app - your trusted source for fact-checked news. Explore, filter, and learn with our user-friendly features, ensuring accuracy at your fingertips.`}
            </Text>
            <Box
