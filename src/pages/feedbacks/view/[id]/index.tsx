          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                {hasAccess('fact_check', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Fact Check"
                    text={
                      <Link as={NextLink} href={`/fact-checks/view/${data?.fact_check?.id}`}>
                        {data?.fact_check?.title}
                      </Link>
                    }
                  />
                )}
