...
function FeedbackCreatePage() {
  ...
  const formik = useFormik<FeedbackInterface>({
    initialValues: {
      ...
      fact_check_id: (router.query.fact_check_id as string) ?? null,
    },
      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <AsyncSelect<UserInterface>
            ...
            labelField={'email'}
          />
          <AsyncSelect<FactCheckInterface>
            formik={formik}
            name={'fact_check_id'}
            label={'Select Fact Check'}
            placeholder={'Select Fact Check'}
            fetcher={getFactChecks}
            labelField={'title'}
          />
