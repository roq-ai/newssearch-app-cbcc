...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'fact_check.create': {
    roles: ['administrator', 'content-moderator', 'feedback-reviewer'],
    key: 'new-fact-check',
    tenantPath: ['company', 'user', 'fact_check'],
    userPath: [],
  },
  'fact_check.update': {
    roles: ['administrator', 'content-moderator', 'feedback-reviewer'],
    key: 'fact-check-updated',
    tenantPath: ['company', 'user', 'fact_check'],
    userPath: [],
  },
  'feedback.create': {
    roles: ['administrator', 'fact-checker', 'feedback-reviewer'],
    key: 'new-feedback',
    tenantPath: ['company', 'user', 'feedback'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['administrator', 'content-moderator', 'fact-checker', 'feedback-reviewer'];
